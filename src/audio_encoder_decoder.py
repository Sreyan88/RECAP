...
""" Classes to support Audio-Encoder-Text-Decoder architectures"""
import timeit
...
class RECAP(PreTrainedModel):
    ...
    def __init__(
        ...
        if config is None:
            config = RECAPConfig.from_encoder_decoder_configs(encoder.config, decoder.config)
        else:
        ...
        self.encoder = encoder.audio_model
        ...
        **kwargs
        ...
        if decoder is None:
            ...
            if "config" not in kwargs_decoder:
                ...
                decoder_config.encoder_hidden_size = encoder.config.audio_config.hidden_size
        ...
        config = RECAPConfig.from_encoder_decoder_configs(encoder.config, decoder.config, **kwargs)
